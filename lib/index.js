...
exports.Fullscreen = exports.WindowReady = exports.CloseWindow = exports.WindowClose = exports.CreateWindow = void 0;
...
function CreateWindow(title, icon) {
    if (icon === void 0) { icon = r.LoadImage('./node_raylib.png'); }
 ...
 */
exports.WindowClose = r.WindowShouldClose();
/**
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, r.SetWindowSize(-1, -1)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 2];
